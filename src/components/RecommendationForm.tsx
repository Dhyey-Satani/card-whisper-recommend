          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <RadioGroup value={formValues.cardType} onValueChange={handleCardTypeChange} className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {cardCategories.map(category => <div key={category.value} className="flex items-center space-x-2">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {cardFeatures.map(feature => <div key={feature.value} className="flex items-center">
                    <input type="checkbox" id={`feature-${feature.value}`} checked={formValues.features.includes(feature.value)} onChange={() => handleFeaturesChange(feature.value)} className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
            ...
            <div className="pt-4">
              <button type="submit" className="w-full bg-blue-600 text-white py-3 px-4 rounded-md font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
