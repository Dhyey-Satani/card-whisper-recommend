...
const CardResult = ({ card, index = 0 }: CardResultProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <Card className="w-full h-full bg-white shadow-lg transition-shadow">
      ...
      >
        <Card className="w-full h-full bg-gradient-to-br from-blue-600 to-indigo-800 text-white shadow-lg overflow-hidden">
          <CardHeader>
          ...
          <CardFooter className="absolute bottom-0 left-0 right-0 bg-black/30 p-3">
